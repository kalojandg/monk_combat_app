 ...
 *
 * Performance and Sleight of Hand rows in the skills table have a green ⓘ icon.
 * Clicking shows a tooltip with the Cunning Intuition description (Mark of Shadow).
 */
